              ...
              <table className="w-full">
                <thead>
                  <tr>
                    ...
                    <th className="table-header text-right">Original (títulos)</th>
                    <th className="table-header text-right">Pago (títulos)</th>
                    <th className="table-header text-right">Em aberto (títulos)</th>
                  </tr>
                </thead>
                <tbody>
                  {[...dados.clientesDevedores]
