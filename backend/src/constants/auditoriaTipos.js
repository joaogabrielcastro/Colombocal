...
const TIPO_LABEL = {
  ...
  CTE_VISUALIZADO: "CT-e visualizado",
  CTE_XML_DOWNLOAD: "Download XML CT-e",
  MDFE_EMITIDO: "MDF-e emitido",
  MDFE_CANCELADO: "MDF-e cancelado",
  MDFE_ENCERRADO: "MDF-e encerrado",
  MDFE_VISUALIZADO: "MDF-e visualizado",
  MDFE_XML_DOWNLOAD: "Download XML MDF-e",
  CIOT_REGISTRADO: "CIOT registrado",
  CIOT_CANCELADO: "CIOT cancelado",
  CIOT_VISUALIZADO: "CIOT visualizado",
  FISCAL_FECHAMENTO_GERADO: "Fechamento fiscal gerado",
  FISCAL_EXPORT_EXCEL: "Exportação Excel fiscal",
  FISCAL_PACOTE_CONTABIL: "Pacote contábil fiscal",
